#!/usr/bin/env bash
#SBATCH -J vena-pgan-picasso-flair
...
#SBATCH --gres=gpu:1
#SBATCH --output=/mnt/home/users/tic_163_uma/mpascual/execs/vena/logs/pgan_picasso_full_flair_%j.out
#SBATCH --error=/mnt/home/users/tic_163_uma/mpascual/execs/vena/logs/pgan_picasso_full_flair_%j.err
...
"${PYTHON}" -m routines.competitors.pgan_cgan.cli "${CONFIG_PATH}"
