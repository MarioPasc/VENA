...
export CONFIG_PATH="${REPO_DIR}/routines/competitors/pgan_cgan/configs/picasso_full_t1pre.yaml"
...
SBATCH_CMD="sbatch --parsable \
    --output=${LOGS_DIR}/pgan_picasso_full_t1pre_%j.out \
    --error=${LOGS_DIR}/pgan_picasso_full_t1pre_%j.err \
    --export=ALL,CONDA_ENV_NAME=${CONDA_ENV_NAME},REPO_DIR=${REPO_DIR},CONFIG_PATH=${CONFIG_PATH},TORCH_HOME=${TORCH_HOME} \
    ${SCRIPT_DIR}/worker_pgan_picasso_full_t1pre.sh"
...
echo "Logs:     ${LOGS_DIR}/pgan_picasso_full_t1pre_${JOB_ID}.{out,err}"
