#!/usr/bin/env bash
#SBATCH -J vena-lddpm-3d-picasso-full
...
#SBATCH --gres=gpu:1
#SBATCH --output=/mnt/home/users/tic_163_uma/mpascual/execs/vena/logs/lddpm_3d_picasso_full_%j.out
#SBATCH --error=/mnt/home/users/tic_163_uma/mpascual/execs/vena/logs/lddpm_3d_picasso_full_%j.err

# 3D-LDDPM competitor full training (Ho et al. 2020 + Eidex et al. 2025 §4).
...
"${PYTHON}" -m routines.competitors.lddpm_3d.cli "${CONFIG_PATH}"
