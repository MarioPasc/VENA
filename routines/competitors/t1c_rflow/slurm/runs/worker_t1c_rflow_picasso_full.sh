#!/usr/bin/env bash
#SBATCH -J vena-t1c-rflow-picasso-full
...
#SBATCH --gres=gpu:1
#SBATCH --output=/mnt/home/users/tic_163_uma/mpascual/execs/vena/logs/t1c_rflow_picasso_full_%j.out
#SBATCH --error=/mnt/home/users/tic_163_uma/mpascual/execs/vena/logs/t1c_rflow_picasso_full_%j.err

# T1C-RFlow competitor full training (Eidex et al. 2025, arXiv:2509.24194).
...
"${PYTHON}" -m routines.competitors.t1c_rflow.cli "${CONFIG_PATH}"
