#!/usr/bin/env bash
#SBATCH -J vena-dit-3d-picasso-full
...
#SBATCH --gres=gpu:1
#SBATCH --output=/mnt/home/users/tic_163_uma/mpascual/execs/vena/logs/dit_3d_picasso_full_%j.out
#SBATCH --error=/mnt/home/users/tic_163_uma/mpascual/execs/vena/logs/dit_3d_picasso_full_%j.err

# 3D-DiT competitor full training (Peebles & Xie 2023 + Eidex 2025 §4).
...
"${PYTHON}" -m routines.competitors.dit_3d.cli "${CONFIG_PATH}"
