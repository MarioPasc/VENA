#!/usr/bin/env bash
#SBATCH -J vena-rembrandt-smoke-1gpu
...
#SBATCH --gres=gpu:1
#SBATCH --output=/mnt/home/users/tic_163_uma/mpascual/execs/vena/logs/rembrandt_smoke_1gpu_%j.out
#SBATCH --error=/mnt/home/users/tic_163_uma/mpascual/execs/vena/logs/rembrandt_smoke_1gpu_%j.err
