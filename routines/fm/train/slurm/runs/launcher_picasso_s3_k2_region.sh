#!/usr/bin/env bash
# Submit the S3 + FFT trunk warm-started K=2 Region-aware-LPL run to Picasso.
#
# Ablation row 2/4 of the 2026-06-19 four-job S3 study.
#
# Usage:
#   bash launcher_picasso_s3_k2_region.sh             # submit
#   bash launcher_picasso_s3_k2_region.sh --dry-run   # print sbatch command
...
export CONFIG_PATH="${REPO_DIR}/routines/fm/train/configs/runs/picasso_s3_k2_region_fft.yaml"
JOB_NAME="vena-s3-k2-region"
