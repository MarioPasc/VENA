#!/usr/bin/env bash
# Submit the S2 + FFT trunk 1000-epoch run to Picasso.
#
# Usage:
#   bash launcher_picasso_s2_fft.sh             # submit
#   bash launcher_picasso_s2_fft.sh --dry-run   # print sbatch command
...
export CONFIG_PATH="${REPO_DIR}/routines/fm/train/configs/runs/picasso_s2_1000ep_fft.yaml"
JOB_NAME="vena-s2-fft"
