#!/usr/bin/env bash
# Submit S1 v3 Variant A (channel-concat at trunk, NO ControlNet) to Picasso.
#
...
#
# Usage:
#   bash launcher_picasso_s1_v3a_fft.sh             # submit
#   bash launcher_picasso_s1_v3a_fft.sh --dry-run   # print sbatch command
...
export CONFIG_PATH="${REPO_DIR}/routines/fm/train/configs/runs/picasso_s1_v3a_concat_only_fft.yaml"
JOB_NAME="vena-s1-v3a-fft"
