#!/usr/bin/env bash
# Submit S3 LPL Batch-2 Arm A (λ_max=0.30 standard) to Picasso.
#
...
#
# Usage:
#   bash launcher_picasso_s3lpl_b2_a_lambda030_standard.sh             # submit
#   bash launcher_picasso_s3lpl_b2_a_lambda030_standard.sh --dry-run   # print sbatch cmd
...
export CONFIG_PATH="${REPO_DIR}/routines/fm/train/configs/runs/picasso_s3lpl_b2_a_lambda030_standard_fft.yaml"
JOB_NAME="vena-s3lpl-b2-a-lambda030-standard"
