#!/usr/bin/env bash
# Submit S1 v3a A6 input-modality ablation {T1pre, FLAIR} (drop T2) to Picasso.
#
...
#
# Usage:
#   bash launcher_picasso_s1_v3a_a6_t1pre_flair.sh             # submit
#   bash launcher_picasso_s1_v3a_a6_t1pre_flair.sh --dry-run   # print sbatch command
...
export CONFIG_PATH="${REPO_DIR}/routines/fm/train/configs/runs/picasso_s1_v3a_a6_t1pre_flair_fft.yaml"
JOB_NAME="vena-s1-v3a-a6-t1pre-flair"
