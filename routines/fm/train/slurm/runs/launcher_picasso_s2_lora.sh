#!/usr/bin/env bash
# Submit the S2 + LoRA r=16 1000-epoch run to Picasso.
#
# Usage:
#   bash launcher_picasso_s2_lora.sh             # submit
#   bash launcher_picasso_s2_lora.sh --dry-run   # print sbatch command
...
export CONFIG_PATH="${REPO_DIR}/routines/fm/train/configs/runs/picasso_s2_1000ep_lora_r16.yaml"
JOB_NAME="vena-s2-lora-r16"
