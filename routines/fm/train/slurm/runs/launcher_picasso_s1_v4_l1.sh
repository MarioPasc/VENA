#!/usr/bin/env bash
# Submit §18 ablation Arm A (L1, median-seeking) to Picasso A100.
# Config: routines/fm/train/configs/runs/picasso_s1_v4_l1_fft.yaml
#
# Usage:
#   bash launcher_picasso_s1_v4_l1.sh             # submit
#   bash launcher_picasso_s1_v4_l1.sh --dry-run   # print sbatch command only
...
export CONFIG_PATH="${REPO_DIR}/routines/fm/train/configs/runs/picasso_s1_v4_l1_fft.yaml"
JOB_NAME="vena-s1-v4-l1-fft"
