#!/usr/bin/env bash
# Submit the S3 + FFT trunk warm-started K=5 Standard-LPL run to Picasso.
#
# Ablation row 3/4 of the 2026-06-19 four-job S3 study.
#
# Usage:
#   bash launcher_picasso_s3_k5_standard.sh             # submit
#   bash launcher_picasso_s3_k5_standard.sh --dry-run   # print sbatch command
...
export CONFIG_PATH="${REPO_DIR}/routines/fm/train/configs/runs/picasso_s3_k5_standard_fft.yaml"
JOB_NAME="vena-s3-k5-standard"
