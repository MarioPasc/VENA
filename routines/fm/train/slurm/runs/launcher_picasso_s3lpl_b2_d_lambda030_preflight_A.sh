#!/usr/bin/env bash
# Submit S3 LPL Batch-2 Arm D (A=[2,3], preflight w_l, λ_max=0.30 standard) to Picasso.
#
...
#
# Usage:
#   bash launcher_picasso_s3lpl_b2_d_lambda030_preflight_A.sh             # submit
#   bash launcher_picasso_s3lpl_b2_d_lambda030_preflight_A.sh --dry-run   # print sbatch cmd
...
export CONFIG_PATH="${REPO_DIR}/routines/fm/train/configs/runs/picasso_s3lpl_b2_d_lambda030_preflight_A_fft.yaml"
JOB_NAME="vena-s3lpl-b2-d-lambda030-preflight-A"
