#!/usr/bin/env bash
# Submit S3 LPL (K=5 standard) warm-started from S1 v3b_rw (full v3) to Picasso.
#
# Ablation S3-C (PRIMARY) of the 2026-06-28 S3-on-top-of-v3 tournament.
# Design doc: .claude/notes/changes/s1_v3/2026-06-28_s1_v3_results_and_s3_plan.md
#
# Usage:
#   bash launcher_picasso_s3_v3b_rw_k5_standard.sh             # submit
#   bash launcher_picasso_s3_v3b_rw_k5_standard.sh --dry-run   # print sbatch cmd
...
export CONFIG_PATH="${REPO_DIR}/routines/fm/train/configs/runs/picasso_s3_v3b_rw_k5_standard_fft.yaml"
JOB_NAME="vena-s3-v3b-rw-k5-standard"
