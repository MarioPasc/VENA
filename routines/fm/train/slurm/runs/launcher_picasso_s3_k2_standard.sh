#!/usr/bin/env bash
# Submit the S3 + FFT trunk warm-started K=2 Standard-LPL run to Picasso.
#
# Ablation row 1/4 of the 2026-06-19 four-job S3 study.
# Companion launchers: launcher_picasso_s3_k2_region.sh,
# launcher_picasso_s3_k5_standard.sh, launcher_picasso_s3_k5_region.sh.
#
# Usage:
#   bash launcher_picasso_s3_k2_standard.sh             # submit
#   bash launcher_picasso_s3_k2_standard.sh --dry-run   # print sbatch command
...
export CONFIG_PATH="${REPO_DIR}/routines/fm/train/configs/runs/picasso_s3_k2_standard_fft.yaml"
JOB_NAME="vena-s3-k2-standard"
