...
#
# Usage:
#   bash launcher_picasso_s1_fft.sh             # submit
#   bash launcher_picasso_s1_fft.sh --dry-run   # print sbatch command
...
export CONFIG_PATH="${REPO_DIR}/routines/fm/train/configs/runs/picasso_s1_1000ep_fft.yaml"
