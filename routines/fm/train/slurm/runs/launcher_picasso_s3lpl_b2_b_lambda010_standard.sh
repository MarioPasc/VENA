#!/usr/bin/env bash
# Submit S3 LPL Batch-2 Arm B (λ_max=0.10 standard, light-regulariser probe) to Picasso.
#
...
#
# Usage:
#   bash launcher_picasso_s3lpl_b2_b_lambda010_standard.sh             # submit
#   bash launcher_picasso_s3lpl_b2_b_lambda010_standard.sh --dry-run   # print sbatch cmd
...
export CONFIG_PATH="${REPO_DIR}/routines/fm/train/configs/runs/picasso_s3lpl_b2_b_lambda010_standard_fft.yaml"
JOB_NAME="vena-s3lpl-b2-b-lambda010-standard"
