"""Unit tests for SynDiff inference helpers — pure math, no checkpoint load.
...
from vena.competitors.syndiff.inference import _crop_to, _psnr, _ssim_3d
...
def test_psnr_finite_for_perturbed() -> None:
    ...
    # 10*log10(1 / 0.01) = 20.0 — symbolic invariant.
...
def test_crop_to_centred() -> None:
    ...
    # 8 rows trimmed on each side (centred crop).
