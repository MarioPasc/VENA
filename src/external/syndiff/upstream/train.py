...
def train_syndiff(rank, gpu, args):
    ...
    for epoch in range(init_epoch, args.num_epoch+1):
        ...
        for iteration, (x1, x2) in enumerate(data_loader):
            ...
            # VENA patch P2: removed `torch.autograd.set_detect_anomaly(True)`
            # — debugging-only, slows training and triggers NaN-detect crashes
            # (upstream issue #43). Our runner under
            # src/vena/competitors/syndiff/runner.py reimplements the loop.
